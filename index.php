...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if ($data && password_verify($password, $data['password'])) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'milan.appservice@gmail.com'; //host email 
        $mail->Password = 'zvpcrrgpaiapxeno'; // app password of your host email
        $mail->Port = 465;
        $mail->SMTPSecure = 'ssl';
        $mail->isHTML(true);
        $mail->setFrom('example@gmail.com', 'Online Examination System');//Sender's Email & Name
